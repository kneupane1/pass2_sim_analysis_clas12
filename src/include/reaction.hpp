...
public:
                          ...
                          double &phiNew)
        {
                ...
                else if (part_id == PROTON)
                {
                        ...
                        if (status_part > 4000)
                        {
                                fact_cd = (0.001948) * pow(p, 3) + (-0.038387) * pow(p, 2) + (0.181457) * p + (1.427647);

                                // fact_cd = (0.000821) * pow(p, 3) + (-0.016500) * pow(p, 2) + (0.103611) * p + (1.393237);
                                fact_cd1 = syst_multi_fact; //(0.001536) * pow(p, 3) + (-0.024778) * pow(p, 2) + (0.119853) * p + (0.832939);
                        ...
                        {
                                fact_fd = (-0.000448) * pow(p, 3) + (0.009443) * pow(p, 2) + (-0.082798) * p + (1.947335);
                ...
                else if (part_id == PIP)
                {
                        ...
                        if (status_part > 4000)
                        {
                                fact_cd = (0.000891) * pow(p, 3) + (-0.011991) * pow(p, 2) + (0.006993) * p + (1.866801);
                ...
                else if (part_id == PIM)
                {
                        ...
                        if (status_part > 4000)
                        {
                                fact_cd = (-0.001201) * pow(p, 3) + (0.014156) * pow(p, 2) + (-0.088521) * p + (2.054783);
                        ...
                        {
                                fact_fd = (0.000062) * pow(p, 3) + (-0.005154) * pow(p, 2) + (0.072283) * p + (1.324110);
                                // fact_fd = (0.000062) * pow(p, 3) + (-0.005154) * pow(p, 2) + (0.072283) * p + (1.324110);

                                // fact_fd = (0.000760) * pow(p, 3) + (-0.021295) * pow(p, 2) + (0.171180) * p + (1.238299);
                                fact_fd1 = syst_multi_fact; //(0.000249) * pow(p, 3) + (-0.007461) * pow(p, 2) + (0.067686) * p + (0.817653);
