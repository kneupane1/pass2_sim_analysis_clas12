...
protected:
    ...
    */
    ...
    // /// MMSQ cuts
    int q2_bin_val = -1;
    // // /////////////////////////// sim data mmsq cuts [Q2][up/down][a,b,c]   /////////////////  updated nov 2025 with background from outside of mmsq cuts
    ////// New cuts after reanalysis mmsq cuts on nov 2025
    double mmsq_cuts[9][2][3] =

        {
            // Q² bin 0: 2.0–2.4 GeV²
            {{-0.15419, 0.58464, -0.45647}, {0.11317, -0.42139, 0.34865}},
            // Q² bin 1: 2.4–3.0 GeV²
            {{-0.11913, 0.47376, -0.37462}, {0.05504, -0.21806, 0.17416}},
            // Q² bin 2: 3.0–3.5 GeV²
            {{-0.09458, 0.38945, -0.30077}, {0.04061, -0.16718, 0.12758}},
            // Q² bin 3: 3.5–4.2 GeV²
            {{-0.06782, 0.30472, -0.23394}, {0.01851, -0.09343, 0.06556}},
            // Q² bin 4: 4.2–5.0 GeV²
            {{-0.06129, 0.29993, -0.24425}, {0.01449, -0.09246, 0.07485}},
            // Q² bin 5: 5.0–6.0 GeV²
            {{-0.01283, 0.12728, -0.09368}, {-0.03260, 0.08042, -0.08181}},
            // Q² bin 6: 6.0–7.0 GeV²
            {{0.03498, -0.03603, 0.04211}, {-0.07185, 0.22032, -0.20498}},
            // Q² bin 7: 7.0–8.0 GeV²
            {{0.06132, -0.12468, 0.11742}, {-0.10210, 0.33366, -0.31177}},
            // Q² bin 8: 8.0–9.0 GeV²
            {{-0.05884, 0.25320, -0.17532}, {-0.16773, 0.57702, -0.53770}},
    };

    // /////////////////////////// exp, sim data mmsq cuts [Q2][up/down][a,b,c]   /////////////////  updated nov 2024
    // /// MMSQ 3 SIGMA mid cuts ////////////////////////////////////// USED IN DISSERTATION
    ...
    double mmsq_cuts_tight[9][2][3] =
        {
            // Q² bin 0: 2.0–2.4 GeV²
            {{-0.13191, 0.50081, -0.38938}, {0.09089, -0.33755, 0.28155}},
            // Q² bin 1: 2.4–3.0 GeV²
            {{-0.10227, 0.40739, -0.32086}, {0.04090, -0.16180, 0.12971}},
            // Q² bin 2: 3.0–3.5 GeV²
            {{-0.08134, 0.33569, -0.25828}, {0.02564, -0.10565, 0.07646}},
            // Q² bin 3: 3.5–4.2 GeV²
            {{-0.06062, 0.27154, -0.20898}, {0.01132, -0.06025, 0.04060}},
            // Q² bin 4: 4.2–5.0 GeV²
            {{-0.05497, 0.26723, -0.21766}, {0.00818, -0.05976, 0.04826}},
            // Q² bin 5: 5.0–6.0 GeV²
            {{-0.01448, 0.12338, -0.09269}, {-0.03095, 0.08433, -0.08280}},
            // Q² bin 6: 6.0–7.0 GeV²
            {{0.02607, -0.01466, 0.02152}, {-0.06295, 0.19896, -0.18439}},
            // Q² bin 7: 7.0–8.0 GeV²
            {{0.04770, -0.08649, 0.08165}, {-0.08848, 0.29547, -0.27601}},
            // Q² bin 8: 8.0–9.0 GeV²
            {{-0.06791, 0.28019, -0.20552}, {-0.15866, 0.55004, -0.50751}},
    };
    // /////////  loose 3.5 sigma cuts /////////////////////
    double mmsq_cuts_loose[9][2][3] = {

        // ===== Polynomial coefficients for MMSQ cuts (SIM) =====

        // Q² bin 0: 2.0–2.4 GeV²
        {{-0.17647, 0.66848, -0.52356}, {0.13545, -0.50522, 0.41574}},
        // Q² bin 1: 2.4–3.0 GeV²
        {{-0.13598, 0.54012, -0.42839}, {0.06918, -0.27432, 0.21861}},
        // Q² bin 2: 3.0–3.5 GeV²
        {{-0.10783, 0.44321, -0.34327}, {0.05223, -0.21489, 0.16449}},
        // Q² bin 3: 3.5–4.2 GeV²
        {{-0.07501, 0.33790, -0.25889}, {0.02571, -0.12661, 0.09052}},
        // Q² bin 4: 4.2–5.0 GeV²
        {{-0.06760, 0.33263, -0.27085}, {0.02081, -0.12516, 0.10144}},
        // Q² bin 5: 5.0–6.0 GeV²
        {{-0.01118, 0.13118, -0.09467}, {-0.03424, 0.07652, -0.08082}},
        // Q² bin 6: 6.0–7.0 GeV²
        {{0.04388, -0.05739, 0.06270}, {-0.08075, 0.24168, -0.22557}},
        // Q² bin 7: 7.0–8.0 GeV²
        {{0.07494, -0.16288, 0.15318}, {-0.11572, 0.37186, -0.34754}},
        // Q² bin 8: 8.0–9.0 GeV²
        {{-0.04976, 0.22622, -0.14512}, {-0.17681, 0.60401, -0.56790}}};
