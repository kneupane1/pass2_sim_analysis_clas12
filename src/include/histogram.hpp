...
protected:
    ...
    // // // //sim FD+CD
    // // std::vector<float> mmsq_low = {-0.01578006, -0.0200282, -0.02613627, -0.03127399, -0.03242353, -0.03743036, -0.04180088}; //, -0.04231708, -0.04231708, -0.04231708};
    // // std::vector<float> mmsq_high = {0.0557954, 0.06455306, 0.07456556, 0.080926, 0.08299776, 0.08875182, 0.09215273};         //, 0.09346989, 0.09346989, 0.09346989};

    // // ///// FD only
    // // std::vector<float> mmsq_low = {-0.01905813, -0.01905813, -0.01905813, -0.01905813, -0.01905813, -0.01905813, -0.01905813};
    // // std::vector<float> mmsq_high = {0.06494187, 0.06494187, 0.06494187, 0.06494187, 0.06494187, 0.06494187, 0.06494187};
    ...
    // /// MMSQ cuts
    int q2_bin_val = -1;
    /////////////////////////// exp data mmsq cuts [Q2][up/down][a,b,c]   /////////////////  last 3 are addeded from 7th one.
    double mmsq_cuts[10][2][3] =
        {{{-0.044692, 0.240447, -0.172116},
          {-0.011637, -0.023096, 0.007153}},
         {{-0.047388, 0.251250, -0.182272},
          {0.008753, -0.097324, 0.072256}},
         {{-0.084169, 0.377768, -0.288886},
          {0.047576, -0.235765, 0.192263}},
         {{-0.000896, 0.086514, -0.041615},
          {-0.014404, -0.017983, 0.003582}},
         {{-0.032204, 0.193462, -0.133872},
          {0.016794, -0.123025, 0.090007}},
         {{0.026306, -0.006984, 0.035382},
          {0.015039, -0.122173, 0.095291}},
         {{0.033182, -0.028618, 0.058098},
          {-0.158528, 0.538503, -0.523559}},
         {{0.033182, -0.028618, 0.058098},
          {-0.158528, 0.538503, -0.523559}},
         {{0.033182, -0.028618, 0.058098},
          {-0.158528, 0.538503, -0.523559}},
    ...
    // // /////////////////////////// sim data mmsq cuts [Q2][up/down][a,b,c]   /////////////////
    // double mmsq_cuts[7][2][3] = {{{0.020127, 0.000664, 0.013575},
    //                               {-0.033397, 0.071318, -0.048512}},
    //                              {{0.032342, -0.046995, 0.058739},
    //                               {-0.043878, 0.110999, -0.084851}},
    //                              {{0.033450, -0.053973, 0.068664},
    //                               {-0.050090, 0.135309, -0.108950}},
    //                              {{0.052149, -0.121656, 0.128726},
    //                               {-0.059683, 0.171690, -0.142625}},
    //                              {{0.061892, -0.157949, 0.162363},
    //                               {-0.068180, 0.205328, -0.175758}},
    //                              {{0.074416, -0.207296, 0.211212},
    //                               {-0.082023, 0.259707, -0.229963}},
    //                              {{0.096298, -0.283450, 0.278576},
    //                               {-0.099728, 0.326673, -0.295410}}};
