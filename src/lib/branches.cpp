...
float Branches12::fmt_x(int i)
{
        return _fmt_x->at(i);
}
float Branches12::fmt_y(int i)
{
        return _fmt_y->at(i);
}
float Branches12::fmt_z(int i)
{
        return _fmt_z->at(i);
}
...
float Branches12::ft_cal_time(int i)
{
        return _ft_cal_time->at(i);
}
float Branches12::ft_cal_path(int i)
{
        return _ft_cal_path->at(i);
}
float Branches12::ft_cal_x(int i)
{
        return _ft_cal_x->at(i);
}
float Branches12::ft_cal_y(int i)
{
        return _ft_cal_y->at(i);
}
float Branches12::ft_cal_z(int i)
{
        return _ft_cal_z->at(i);
}
float Branches12::ft_cal_dx(int i)
{
        return _ft_cal_dx->at(i);
}
float Branches12::ft_cal_dy(int i)
{
        return _ft_cal_dy->at(i);
}
float Branches12::ft_cal_radius(int i)
{
...
float Branches12::ft_hodo_time(int i)
{
        return _ft_hodo_time->at(i);
}
float Branches12::ft_hodo_path(int i)
{
        return _ft_hodo_path->at(i);
}
float Branches12::ft_hodo_x(int i)
{
        return _ft_hodo_x->at(i);
}
float Branches12::ft_hodo_y(int i)
{
        return _ft_hodo_y->at(i);
}
float Branches12::ft_hodo_z(int i)
{
        return _ft_hodo_z->at(i);
}
float Branches12::ft_hodo_dx(int i)
{
        return _ft_hodo_dx->at(i);
}
float Branches12::ft_hodo_dy(int i)
{
        return _ft_hodo_dy->at(i);
}
float Branches12::ft_hodo_radius(int i)
{
