                              ...
                              double x1, double x2, double y1, double y2, double el, double eh, double sl, double sh, double eff1, double eff2, double r1, double r2)
{
    ...
    // Save canvas
    canvas->SaveAs(("/Users/krishnaneupane/Documents/AA_PhD_useful_documents/My_PhD_work/detector_ineff_plots/" + name + "_including_Ineff_cuts.png").c_str());
...
void det_ineff_plots()
{
    ...
    std::vector<HistogramInfo> histograms = {
        {"pcal_sec_after_all_cuts", "Electron PCAL y versus x", -350, 350, -350, 350, 1, 200, 0.005, 1.95, 0.05, 3, 75, 270},
    ...
    // std::vector<HistogramInfo> histograms = {
    //     // {"Theta_fd_prot_lab_vs_mom_prot_after_all_cuts", "Theta vs mom prot fd all", -350, 350, -350, 350},
    //     {"dcr1_sec_pip_after_all_cuts", "Pip DCR1 y versus x", -170, 170, -170, 170, 1, 30, 0.005, 0.05, 0.0, 2.5, 38, 145},
    //     {"dcr2_sec_pip_after_all_cuts", "Pip DCR2 y versus x", -270, 270, -270, 270, 1, 30, 0.005, 0.05, 0.0, 2.5, 66, 220},
    //     {"dcr3_sec_pip_after_all_cuts", "Pip DCR3 y versus x", -420, 420, -420, 420, 1, 30, 0.005, 0.07, 0.0, 2.5, 140, 340},
    // };
